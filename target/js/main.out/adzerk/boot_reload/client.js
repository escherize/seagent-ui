...
cljs.core._add_method.call(null,adzerk.boot_reload.client.handle,new cljs.core.Keyword(null,"reload","reload",863702807),(function (p__6927,opts){
...
var files = cljs.core.get.call(null,map__6928__$1,new cljs.core.Keyword(null,"files","files",-472457450));
...
var len__6046__auto___6934 = arguments.length;
var i__6047__auto___6935 = (0);
while(true){
if((i__6047__auto___6935 < len__6046__auto___6934)){
args__6053__auto__.push((arguments[i__6047__auto___6935]));

var G__6936 = (i__6047__auto___6935 + (1));
i__6047__auto___6935 = G__6936;
continue;
} else {
}
break;
...
adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic = (function (url,p__6932){
var vec__6933 = p__6932;
var opts = cljs.core.nth.call(null,vec__6933,(0),null);
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"opened","opened",-1451743091),((function (conn,vec__6933,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"message","message",-406056002),((function (conn,vec__6933,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"closed","closed",-919675359),((function (conn,vec__6933,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"error","error",-978969032),((function (conn,vec__6933,opts){
return (function (evt){
...
adzerk.boot_reload.client.connect.cljs$lang$applyTo = (function (seq6930){
var G__6931 = cljs.core.first.call(null,seq6930);
var seq6930__$1 = cljs.core.next.call(null,seq6930);
return adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic(G__6931,seq6930__$1);
});
