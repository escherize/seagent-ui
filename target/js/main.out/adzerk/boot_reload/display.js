...
return (function (p__6455){
var vec__6456 = p__6455;
var attr = cljs.core.nth.call(null,vec__6456,(0),null);
...
var args6457 = [];
var len__6046__auto___6460 = arguments.length;
var i__6047__auto___6461 = (0);
while(true){
if((i__6047__auto___6461 < len__6046__auto___6460)){
args6457.push((arguments[i__6047__auto___6461]));

var G__6462 = (i__6047__auto___6461 + (1));
i__6047__auto___6461 = G__6462;
continue;
} else {
}
break;
...
var len__6046__auto___6465 = arguments.length;
var i__6047__auto___6466 = (0);
while(true){
if((i__6047__auto___6466 < len__6046__auto___6465)){
args__6053__auto__.push((arguments[i__6047__auto___6466]));

var G__6467 = (i__6047__auto___6466 + (1));
i__6047__auto___6466 = G__6467;
continue;
} else {
}
break;
...
adzerk.boot_reload.display.style.cljs$lang$applyTo = (function (seq6464){
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq6464));
});
...
adzerk.boot_reload.display.exception_node = (function adzerk$boot_reload$display$exception_node(p__6468){
var map__6472 = p__6468;
var map__6472__$1 = ((((!((map__6472 == null)))?((((map__6472.cljs$lang$protocol_mask$partition0$ & (64))) || (map__6472.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__6472):map__6472);
var data = map__6472__$1;
var message = cljs.core.get.call(null,map__6472__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__6472__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__6472__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__6474 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,message);
goog.events.listen(G__6474,goog.events.EventType.CLICK,((function (G__6474,map__6472,map__6472__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__6474,map__6472,map__6472__$1,data,message,line,file))
);

return G__6474;
});
adzerk.boot_reload.display.warning_node = (function adzerk$boot_reload$display$warning_node(p__6475){
var map__6479 = p__6475;
var map__6479__$1 = ((((!((map__6479 == null)))?((((map__6479.cljs$lang$protocol_mask$partition0$ & (64))) || (map__6479.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__6479):map__6479);
var data = map__6479__$1;
var message = cljs.core.get.call(null,map__6479__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__6479__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__6479__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__6481 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),message),adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),[cljs.core.str("at line "),cljs.core.str(line)].join('')),adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),file)], null));
goog.events.listen(G__6481,goog.events.EventType.CLICK,((function (G__6481,map__6479,map__6479__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__6481,map__6479,map__6479__$1,data,message,line,file))
);
...
adzerk.boot_reload.display.construct_hud_node = (function adzerk$boot_reload$display$construct_hud_node(p__6482){
var map__6486 = p__6482;
var map__6486__$1 = ((((!((map__6486 == null)))?((((map__6486.cljs$lang$protocol_mask$partition0$ & (64))) || (map__6486.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__6486):map__6486);
var messages = map__6486__$1;
var warnings = cljs.core.get.call(null,map__6486__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__6486__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
var G__6488 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"pad","pad",-36734541),new cljs.core.Keyword(null,"flex","flex",-1425124628),new cljs.core.Keyword(null,"flex-c","flex-c",1898731114),(cljs.core.truth_(exception)?new cljs.core.Keyword(null,"bg-red","bg-red",-1645498040):((cljs.core.seq.call(null,warnings))?new cljs.core.Keyword(null,"bg-yellow","bg-yellow",-1293468429):new cljs.core.Keyword(null,"bg-clear","bg-clear",-673074101)
))));
goog.dom.append(G__6488,adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"logo","logo",1237980263),new cljs.core.Keyword(null,"mr10","mr10",-144509621)),goog.dom.htmlToDocumentFragment(adzerk.boot_reload.display.cljs_logo)));

goog.dom.append(G__6488,(cljs.core.truth_(exception)?adzerk.boot_reload.display.exception_node.call(null,exception):((cljs.core.seq.call(null,warnings))?adzerk.boot_reload.display.warnings_node.call(null,warnings):adzerk.boot_reload.display.reloaded_node.call(null)
)));
...
adzerk.boot_reload.display.insert_container_BANG_ = (function adzerk$boot_reload$display$insert_container_BANG_(id,p__6489){
var map__6492 = p__6489;
var map__6492__$1 = ((((!((map__6492 == null)))?((((map__6492.cljs$lang$protocol_mask$partition0$ & (64))) || (map__6492.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__6492):map__6492);
var messages = map__6492__$1;
var warnings = cljs.core.get.call(null,map__6492__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__6492__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
var show_BANG_ = ((function (hud,el,map__6492,map__6492__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,map__6492,map__6492__$1,messages,warnings,exception))
;
var no_prob_QMARK_ = (cljs.core.not.call(null,exception)) && (cljs.core.not.call(null,cljs.core.seq.call(null,warnings)));
var hide_BANG_ = ((function (hud,el,show_BANG_,no_prob_QMARK_,map__6492,map__6492__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,show_BANG_,no_prob_QMARK_,map__6492,map__6492__$1,messages,warnings,exception))
;
...
}catch (e6495){if((e6495 instanceof Error)){
var __6496 = e6495;
} else {
throw e6495;
