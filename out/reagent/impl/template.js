...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__7757__auto__,writer__7758__auto__,opt__7759__auto__){
return cljs.core._write.call(null,writer__7758__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__7159__auto__ = reagent.impl.template.named_QMARK_.call(null,x);
...
var or__7159__auto__ = reagent.impl.template.hiccup_tag_QMARK_.call(null,x);
if(cljs.core.truth_(or__7159__auto__)){
return or__7159__auto__;
} else {
...
var G__8710 = o;
(G__8710[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
var old_8714 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_8714))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_8714)].join(''):class$));
} else {
}
...
if(cljs.core.not.call(null,(function (){var and__7147__auto__ = (node === document.activeElement);
if(and__7147__auto__){
var and__7147__auto____$1 = reagent.impl.template.has_selection_api_QMARK_.call(null,(node["type"]));
if(cljs.core.truth_(and__7147__auto____$1)){
return (typeof value === 'string') && (typeof node_value === 'string');
} else {
return and__7147__auto____$1;
}
} else {
...
if(cljs.core.truth_((function (){var and__7147__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__8717 = jsprops;
(G__8717["defaultValue"] = value);

(G__8717["onChange"] = ((function (G__8717,v,value,on_change){
return (function (p1__8715_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__8715_SHARP_);
});})(G__8717,v,value,on_change))
);
...
var vec__8719 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__8719,(0),null);
var id = cljs.core.nth.call(null,vec__8719,(1),null);
var class$ = cljs.core.nth.call(null,vec__8719,(2),null);
...
var temp__4427__auto__ = (function (){var G__8723 = cljs.core.meta.call(null,v);
var G__8723__$1 = (((G__8723 == null))?null:reagent.impl.template.get_key.call(null,G__8723));
return G__8723__$1;
})();
if((temp__4427__auto__ == null)){
...
var jsprops = {"argv": v};
var G__8725_8726 = v;
var G__8725_8727__$1 = (((G__8725_8726 == null))?null:reagent.impl.template.key_from_vec.call(null,G__8725_8726));
var G__8725_8728__$2 = (((G__8725_8727__$1 == null))?null:(jsprops["key"] = G__8725_8727__$1));
...
var p = (function (){var temp__4427__auto__ = (function (){var G__8731 = cljs.core.meta.call(null,argv);
var G__8731__$1 = (((G__8731 == null))?null:reagent.impl.template.get_key.call(null,G__8731));
return G__8731__$1;
})();
if((temp__4427__auto__ == null)){
return jsprops;
...
var G__8732 = (((jsprops == null))?{}:jsprops);
(G__8732["key"] = key);
...
var G__8733 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__8733;
continue;
}
} else {
...
var n__8062__auto___8734 = a.length;
var i_8735 = (0);
while(true){
if((i_8735 < n__8062__auto___8734)){
(a[i_8735] = reagent.impl.template.as_element.call(null,(a[i_8735])));
...
var a = cljs.core.into_array.call(null,s);
var n__8062__auto___8737 = a.length;
var i_8738 = (0);
while(true){
if((i_8738 < n__8062__auto___8737)){
var val_8739 = (a[i_8738]);
if((cljs.core.vector_QMARK_.call(null,val_8739)) && ((reagent.impl.template.key_from_vec.call(null,val_8739) == null))){
(o["no-key"] = true);
} else {
}

(a[i_8738] = reagent.impl.template.as_element.call(null,val_8739));
...
if(cljs.core.truth_((function (){var and__7147__auto__ = cljs.core.not.call(null,reagent.impl.component._STAR_non_reactive_STAR_);
if(and__7147__auto__){
return (ctx["no-key"]);
} else {
return and__7147__auto__;
...
var G__8742 = (cljs.core.count.call(null,argv) - first_child);
switch (G__8742) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__8742){
